...
class ClinicalPatientMatcher:
    ...
    def _initialize_strategies(self) -> List[MatchingStrategy]:
        ...
        return [
            MatchingStrategy(
                name="GOLD_STANDARD",
                rules=["family_name_exact", "given_name_exact", "dob_exact", "gender_exact"],
                confidence=1.0,
                priority=1,
            ...
            MatchingStrategy(
                ...
                rules=["family_name_exact", "given_name_exact", "dob_exact", "gender_loose"],
                confidence=0.98,
                priority=2,
            ...
            MatchingStrategy(
                name="FLIPPED_EXACT",
                rules=["family_name_flipped_exact", "given_name_flipped_exact", "dob_exact", "gender_exact"],
                confidence=0.97,
                priority=3,
            ...
            MatchingStrategy(
                ...
                rules=["family_name_flipped_exact", "given_name_flipped_exact", "dob_exact", "gender_loose"],
                confidence=0.90,
                priority=4,
            ...
            MatchingStrategy(
                name="PARTIAL_EXACT",
                rules=["family_name_partial", "given_name_partial", "dob_exact", "gender_exact"],
                confidence=0.85,
                priority=5,
            ...
            MatchingStrategy(
                ...
                rules=["family_name_partial", "given_name_partial", "dob_exact", "gender_loose"],
                confidence=0.75,
                priority=6,
            ...
            MatchingStrategy(
                ...
                rules=["family_name_exact", "given_name_exact", "dob_fuzzy", "gender_exact"],
                confidence=0.72,
                priority=7,
            ...
            MatchingStrategy(
                ...
                rules=["family_name_flipped_exact", "given_name_flipped_exact", "dob_fuzzy", "gender_loose"],
                confidence=0.65,
                priority=8,
            ...
            MatchingStrategy(
                ...
                rules=["family_name_partial", "given_name_partial", "dob_fuzzy", "gender_loose"],
                confidence=0.55,
                priority=9,
    ...
    def match_patient(self, dtx_record: dict, pms_lookup: Dict[str, Any]) -> MatchResult:
        ...
        for strategy in self.strategies:
            match_result = self._evaluate_strategy(dtx_record, pms_lookup, strategy, keys)
    ...
    def _evaluate_strategy(self, 
        ...
        if match_key and match_key in pms_lookup:
            ...
            corrections = self._identify_corrections(dtx_record, pms_data, strategy)
            ...
            requires_review = self.confidence_calculator.requires_manual_review(adjusted_confidence)
            
            return MatchResult(
                match_found=True,
                pms_data=PatientRecord(**pms_data) if isinstance(pms_data, dict) else pms_data,
