...
from dtxstudio_patient_info.core.patient_matcher import ClinicalPatientMatcher, MatchingConfig
...
class TestClinicalPatientMatcher(unittest.TestCase):
    ...
    def test_session_statistics(self):
        ...
        # Run several matches
        test_records = [
            PatientRecord("Smith", "John", "Male", "1990-01-15", source_system="dtx"),
            PatientRecord("Doe", "Jane", "Female", "1985-03-22", source_system="dtx"),
            PatientRecord("NoMatch", "Person", "Unknown", "2000-01-01", source_system="dtx")
        ]
...
class TestKeyBuilders(unittest.TestCase):
    ...
    def test_key_normalization(self):
        ...
        key1 = create_exact_match_key("  Smith  ", "JOHN", "male", "1990-01-15")
...
class TestItalianCodiceFiscale(unittest.TestCase):
    ...
    def test_extract_gender_from_codice_fiscale(self):
        ...
        self.assertEqual(extract_gender_from_codice_fiscale("RSSMRA85A15H501Z"), "MALE")
        self.assertEqual(extract_gender_from_codice_fiscale("BNCGVN70C01F205X"), "MALE") 
        
        # Female examples (day 41-71, i.e., actual day + 40)
        self.assertEqual(extract_gender_from_codice_fiscale("RSSMRA85A55H501Z"), "FEMALE")  # 55 = 15 + 40
        self.assertEqual(extract_gender_from_codice_fiscale("BNCGVN70C41F205X"), "FEMALE")  # 41 = 01 + 40
        
        # Invalid cases
        self.assertIsNone(extract_gender_from_codice_fiscale(""))
        self.assertIsNone(extract_gender_from_codice_fiscale("SHORT"))
        self.assertIsNone(extract_gender_from_codice_fiscale("INVALID99A99H501Z"))  # Day 99 invalid
    
    def test_validate_codice_fiscale_gender(self):
        """Test gender validation against codice fiscale."""
        # Valid cases
        is_valid, correction = validate_codice_fiscale_gender("MALE", "RSSMRA85A15H501Z")
        self.assertTrue(is_valid)
        self.assertIsNone(correction)
        
        is_valid, correction = validate_codice_fiscale_gender("FEMALE", "RSSMRA85A55H501Z")
        self.assertTrue(is_valid)
        self.assertIsNone(correction)
        
        # Invalid case - gender mismatch
        is_valid, correction = validate_codice_fiscale_gender("FEMALE", "RSSMRA85A15H501Z")
...
class TestClinicalScenarios(unittest.TestCase):
    ...
    def test_gender_data_quality_issue(self):
        ...
        result = self.matcher.match_patient(dtx_record, clinical_data_wrong_gender)
